...
opt_chunk_size(ctg) <- 10 # retile to 250 m
plot(ctg, chunk = TRUE)
ctg <- catalog_retile(ctg) # apply retile
...
### Processar métricas de copa: lidUrb, lidR e rLiDAR
...
```{r}
# ABRIR GEODATASETS
sf <- paste0(out, "/Metricas_MLS_points.gpkg")
